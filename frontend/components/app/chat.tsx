...
export const Chat = () => {
  ...
  return (
    <div className="flex-1">
      <header className="bg-white p-4 text-gray-700 border">
        {messages.length > 0 ? (
      ...
      <div className="h-screen overflow-y-auto chat-scroll-bar pb-16">
        ...
        <footer className="flex flex-col absolute bottom-[-88px] w-2/4 bg-white border-t border-gray-300 p-4 border">
